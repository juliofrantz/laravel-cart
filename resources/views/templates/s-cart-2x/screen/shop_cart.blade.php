                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table  table-bordered table-responsive">
                                ...
                                <td class="form-group{{ $errors->has('first_name_kana') ? ' has-error' : '' }}">
                                    <label for="first_name_kana" class="control-label"><i class="fa fa-user"></i>
                                        {{ trans('cart.first_name_kana') }}:</label>
                                    <input name="first_name_kana" type="text"
                                ...
                                <td class="form-group{{ $errors->has('last_name_kana') ? ' has-error' : '' }}">
                                    <label for="last_name_kana" class="control-label"><i class="fa fa-user"></i>
                                        {{ trans('cart.last_name_kana') }}:</label>
                                    <input name="last_name_kana" type="text" placeholder="{{ trans('cart.last_name_kana') }}"
