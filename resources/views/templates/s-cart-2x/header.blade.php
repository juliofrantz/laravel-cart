                        ...
                        <li>
                            ...
                            <div class="header-top-popup-wrap">
                                <ul>
                                    @guest
                                    <li>
                                        <a href="{{sc_route('login') }}">{{ trans('front.login') }}</a>
                                    </li>
                                    @if (!empty(sc_config('LoginSocialite')))
                                    <li>
                                      <a href="{{ sc_route('login_socialite.index', ['provider' => 'facebook']) }}"><i class="fab fa-facebook"></i>
                                         {{ trans('front.login') }} facebook</a>
                                    </li>
                                    <li>
                                      <a href="{{ sc_route('login_socialite.index', ['provider' => 'google']) }}"><i class="fab fa-google-plus"></i>
                                         {{ trans('front.login') }} google</a>
                                    </li>
                                    <li>
                                      <a href="{{ sc_route('login_socialite.index', ['provider' => 'github']) }}"><i class="fab fa-github"></i>
                                         {{ trans('front.login') }} github</a>
                                    </li>
                                    @endif
                                    @else
                                    <li>
                                        <a href="{{sc_route('member.index') }}">{{ trans('front.account') }}</a>
                                    </li>
                                    <li>
                                        <a href="{{sc_route('logout') }}"
        ...
        <div class="container-sm container">
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-8 header-middle-menu">
                    <form action="{{sc_route('search') }}" method="get" class="form-inline form-search">
                        <input class="form-control" type="search" name="keyword"
                            placeholder="{{ trans('front.search_form.keyword') }}..." aria-label="Search">
                        <button class="btn btn-outline-success my-2 my-sm-0" type="submit"><i
                                class="fa fa-search"></i></button>
                    </form>
                    <a href="{{sc_route('wishlist') }}"><i class="fas fa-heart"></i> <span
                    ...
                    <a href="{{sc_route('cart') }}"><i class="fa fa-shopping-cart"></i> <span
                        ...
                        <div class="navbar-collapse collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item active">
                                    <a class="nav-link" href="{{sc_route('home') }}">{{ trans('front.home') }} <span
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item"
                                            href="{{sc_route('product.all') }}">{{ trans('front.all_product') }}</a>
                                        <a class="dropdown-item"
                                            href="{{sc_route('compare') }}">{{ trans('front.compare') }}</a>
                                        <a class="dropdown-item"
                                            href="{{sc_route('cart') }}">{{ trans('front.cart_title') }}</a>
                                        <a class="dropdown-item"
                                            href="{{sc_route('category.all') }}">{{ trans('front.categories') }}</a>
                                        <a class="dropdown-item"
                                            href="{{sc_route('brand.all') }}">{{ trans('front.brands') }}</a>
                                        <a class="dropdown-item"
                                            href="{{sc_route('supplier.all') }}">{{ trans('front.suppliers') }}</a>
                                    </div>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{sc_route('news') }}">{{ trans('front.blog') }}</a>
                                </li>
