            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-panel">
                ...
                <div class="rd-navbar-brand">
                  <!--Brand--><a class="brand" href="{{ sc_route('home') }}" style="margin: 10px auto 0 auto;"><img class="brand-logo-dark" src="{{ asset(sc_store('logo')) }}" alt="" width="105" height="44"/>
              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    <li class="rd-nav-item"><a class="rd-nav-link" href="{{ sc_route('home') }}">{{ trans('front.home') }}</a></li>
